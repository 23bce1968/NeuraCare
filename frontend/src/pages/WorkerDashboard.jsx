                            ...
                            <button className="relative p-2 hover:bg-gray-100 rounded-xl transition-all">
                              ...
                              <div className="relative">
                                  <button
                                      ...
                                      className="hidden sm:flex items-center gap-3 pl-3 border-l border-gray-200 hover:bg-gray-100 rounded-xl transition-all px-2 py-1"
                                  >
                                  ...
                                  {/* DROPDOWN */}
                                  {showUserDropdown && (
                                      <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-xl border border-gray-200 p-3 animate-in fade-in zoom-in-95">
                                          ...
                                          <div className="p-3 space-y-2 text-sm">
                                              <div className="flex justify-between">
                                                  ...
                                                  <span className="font-medium">{userData.workerId}</span>
                                              </div>
                                          ...
                                          <button
                                              ...
                                              className="w-full mt-2 flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 font-medium transition-all"
                                          >
